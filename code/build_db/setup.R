...
stopifnot(file.exists('data/temp/allotments/allotments_clean.shp')) # import into GEE
...
source('code/build_db/2_allotment_ownership_and_info.R')
...
source('code/build_db/3_process_annual_data.R')
